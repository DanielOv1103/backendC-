...
namespace AirPortApi.Repositories
{
    public class AirPortRepositories
    {
        ...
        private readonly List<AirportsModel> _airports = new();
        ...
        {
            airport.Id = _airports.Max(x => x.Id) + 1;
            _airports.Add(airport);
            return airport;
        }

        public AirportsModel UpdateAirport(AirportsModel airport)
        {
        ...
        public AirportsModel DeleteAirport(int id)
        {
